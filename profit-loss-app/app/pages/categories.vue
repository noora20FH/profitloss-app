...
<template>
  <div class="p-8 max-w-4xl mx-auto my-10">
    ...
    <!-- Loading State -->
    <div v-if="pending" class="p-4 text-center text-gray-500">Memuat data...</div>
    <!-- Error State -->
    <div v-else-if="error" class="p-4 bg-red-100 text-red-700 rounded-lg">Gagal memuat data: {{ error.message }}</div>
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="flex justify-end space-x-3">
            ...
            <button 
              ...
              :class="isSubmitting ? 'bg-indigo-400' : 'bg-indigo-600 hover:bg-indigo-700'"
            >
